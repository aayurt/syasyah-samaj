          ...
          <div>
            ...
            <div className="relative mt-1">
              <input
                ...
                className="w-full rounded border border-slate-300 px-3 py-2.5 pr-10 text-sm outline-none focus:border-slate-500"
              />
            </div>
          </div>
        </div>
                  ...
                  <tr key={l.key} className="border-b border-slate-50">
                      ...
                      {isInventory ? (
                        <div className="relative">
                          <input
                            ...
                            className="w-full rounded border border-slate-200 px-2 py-1.5 text-sm outline-none focus:border-slate-500"
                          />
                    ...
                    <td className="px-2 py-2">
                      <input type="number" min="0" step="any" value={l.qty}
                        ...
                        className="w-full rounded border border-slate-200 px-2 py-1.5 text-right font-mono text-sm outline-none focus:border-slate-500" />
                    </td>
                    <td className="px-2 py-2">
              ...
              {journalLines.map((l) => (
                <tr key={l.key} className="border-b border-slate-50">
                  ...
                  <td className="px-2 py-2"><input type="number" step="0.01" min="0" value={l.debit}
                    ...
                    className="w-full rounded border border-slate-200 px-2 py-1.5 text-right font-mono text-sm outline-none focus:border-slate-500" /></td>
                  ...
                  <td className="px-2 py-2"><input type="text" value={l.memo}
                    ...
                    className="w-full rounded border border-slate-200 px-2 py-1.5 text-sm outline-none focus:border-slate-500" /></td>
                  <td className="px-2 py-2 text-center">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <label className="text-sm text-slate-700">
              ...
              <select value={fromAccount} onChange={(e) => setFromAccount(e.target.value)}
                className="mt-1 w-full rounded border border-slate-300 px-3 py-2.5 text-sm outline-none focus:border-slate-500">
                <option value="">— select —</option>
      ...
      <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div className="rounded-lg border border-slate-200 bg-white p-5">
          ...
          <textarea rows={4} value={narration} onChange={(e) => setNarration(e.target.value)}
            ...
            className="mt-2 w-full resize-none rounded border border-slate-300 px-3 py-2.5 text-sm outline-none focus:border-slate-500" />
        </div>
        <div className="rounded-lg border border-slate-200 bg-white p-5">
          <div className="space-y-4">
            <div>
              <label className="text-sm font-medium text-slate-700">Total Amount</label>
              <div className="mt-1 rounded border border-slate-200 bg-slate-50 px-3 py-2.5 font-mono text-lg font-semibold text-slate-800">
                Rs. {fmt(grandTotal)}
              </div>
            </div>
            {isCash && (
              <div>
                ...
                <div className="mt-1 rounded border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm text-slate-700">
