...
export default function VoucherForm({ mode }: Props) {
  ...
  return (
    <div className="mx-auto max-w-5xl pb-28">
      ...
      {/* ── Tax Lines (collapsible) ─────────────────────────── */}
      {isTaxable && (
        <div className="mt-4">
          <CollapsibleSection
            title="Tax Lines"
            open={taxSectionOpen}
            onToggle={() => setTaxSectionOpen((o) => !o)}
            badge={vatTotal > 0 ? fmt(vatTotal) : undefined}
          >
      ...
      {isTaxable && (
        <div className="mt-4">
          <CollapsibleSection
            ...
            open={tdsSectionOpen}
            onToggle={() => setTdsSectionOpen((o) => !o)}
            badge={tdsEnabled && tdsAmount > 0 ? fmt(tdsAmount) : undefined}
          >
