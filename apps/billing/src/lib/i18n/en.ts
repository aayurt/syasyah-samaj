...
export const en = {
  ...
  status: {
    ...
    approved: 'Approved',
    rejected: 'Rejected',
    queuedForPosting: '⏳ Queued for Posting (सिङ्क पर्खिएको)',
  },
  ...
  dataManagement: {
    ...
    removes: 'Removes',
    keeps: 'Keeps',
    tenantWarningCentral: 'Select the tenant to clean up from the header switcher.',
    tenantWarningTenant: 'Your tenant is auto-selected. Use the header switcher if you can reach another.',
    typeToConfirm: 'Type {phrase} to confirm',
    typeToConfirmLabel: 'Type',
    typeToConfirmSuffix: 'to confirm',
    rowsRemoved: 'Removed {n} row(s) · voucher counters reset to 0',
    deletedCount: '{n} deleted',
    keptCount: '{n} kept',
    countersReset: 'Voucher numbering picks up again after the highest remaining number.',
    seedDesc: 'Bootstrap a starter chart of accounts, default mappings, a 13% VAT, sample parties and items, and 5 draft vouchers that land in the Posting queue — great for trying the app before your real data. Masters are created only when missing.',
    seedDisabled: 'Demo data is disabled in Settings → Feature Toggles → "Demo seed". Enable it to run the seeder.',
    seedButton: 'Add demo data',
    seeding: 'Seeding…',
    seedSelectTenant: 'Select a tenant from the header switcher first.',
    seedResult: 'Chart: {g} groups, {a} accounts · {p} parties · {d} draft vouchers.',
    seedReview: 'Review drafts in the Posting queue →',
    importExport: 'Import / Export',
    importExportDesc: 'Export your data as JSON for backup, or import data from another system. Imported records are compared against existing data — you choose what to keep.',
  ...
  cleanupItems: {
    ...
    openingBalances: 'Opening balances',
    fixedAssets: 'Fixed assets',
    ilakas: 'Ilakas / Tenants',
    accounts: 'Accounts & groups',
    parties: 'Parties',
    items: 'Items',
    members: 'Members & membership types',
    taxTypes: 'Tax types',
    fiscalYears: 'Fiscal years',
    users: 'Users & roles',
  ...
  sync: {
    ...
    draftCredit: 'Credit',
    draftMemo: 'Memo',
    resyncIn: 'Resync in {n}s',
    resyncing: 'Resyncing…',
    pending: '{n} to sync',
    resync: 'Resync',
    resyncAria: 'Resync — push queued changes and pull the latest data from the server',
    // ── Non-intrusive header pill + conflict drawer ──
    syncedLabel: 'Synced',
    syncedTitle: 'All changes synced',
    pendingSync: '{n} pending sync',
    pendingHint: 'Changes waiting to sync. Click to sync now.',
    offline: 'Offline',
    savedLocally: 'Saved locally',
    offlineHint: 'Offline — your changes are saved on this device and will sync automatically when you reconnect.',
    reviewQueued: '{n} to review',
    reviewHint: 'Changes the server could not accept — review, edit, or discard them.',
    drawerTitle: 'Needs review',
    drawerSubtitle: 'These changes are saved on this device but the server could not accept them.',
    noConflicts: 'Nothing needs review.',
    drawerFooter: 'Saved locally — nothing is lost',
    queuedAt: 'Queued {d}',
    queuedDraft: 'Queued draft',
    close: 'Close',
    retryTitle: 'Clear the conflict and try syncing again',
    discardTitle: 'Remove this queued change permanently',
    resolveTitle: 'Compare your version with the server and resolve',
  },
  recentActivity: {
