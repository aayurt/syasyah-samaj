...
export default function PrintVoucher({ doc, accounts, partyName, orgName, orgAddress }: Props) {
  ...
  return (
    <div className="print-voucher">
      ...
      <div className="mt-2 text-center text-[9px] text-slate-400">
        Generated by Syasya Accounting · {new Date().toLocaleString()}
      </div>
    </div>
  )
}
