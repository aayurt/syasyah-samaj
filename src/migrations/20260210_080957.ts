...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_tickets_status" AS ENUM('unused', 'checked-in', 'cancelled', 'refunded', 'transferred');
  ...
  CREATE TABLE "events" (
  	...
  	"location_map_location" varchar,
  	"location_latitude" numeric,
  	"location_longitude" numeric,
  	"start_datetime" timestamp(3) with time zone DEFAULT '2026-02-10T08:09:57.210Z',
  	"end_datetime" timestamp(3) with time zone DEFAULT '2026-02-10T08:09:57.211Z',
  ...
  CREATE TABLE "tickets" (
  	...
  	"code" varchar,
  	"status" "enum_tickets_status" DEFAULT 'unused',
  ...
  CREATE INDEX "orders_rels_tickets_id_idx" ON "orders_rels" USING btree ("tickets_id");
