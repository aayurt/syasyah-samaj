        ...
        <div className="container relative z-10 text-center text-white space-y-8 pt-[14rem] md:pt-[7rem] lg:[0rem]">
          <div className="space-y-4">
            ...
            <div className="text-xl md:text-2xl max-w-3xl mx-auto text-gray-300 space-y-6">
              ...
              <p>
                We help Nepalese event organisers across the UK promote their events, reach wider
                audiences, and connect with the community more effectively. By bringing Nepalese
                events into one dedicated platform, we make it easier for people to discover what’s
                happening — helping organisers grow attendance and build stronger community
                connections.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            ...
            <Link href="/contact-us">
              <Button
                size="lg"
                variant="secondary"
                className="text-lg px-8 py-7 rounded-full bg-white/10 hover:bg-white/20 border-white/20 backdrop-blur-md text-white transition-all uppercase"
              >
                Sign Up My Event
              </Button>
            </Link>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 pt-12 opacity-80 hover:opacity-100 transition-opacity">
            <p className="w-full text-sm font-medium uppercase tracking-widest text-gray-400 mb-2">
              Download the Mobile App
            </p>
            <Button
              variant="outline"
              className="bg-black/40 border-white/10 text-white rounded-xl py-6 px-6 flex items-center gap-3 hover:bg-black/60 transition-all mb-8"
            >
              <svg
                fill="white"
                width="20px"
        ...
        <div className="container">
          <div className="max-w-3xl mb-20">
            ...
            <p className="text-muted-foreground text-xl leading-relaxed">
              Everything you need to sell tickets, manage attendees, and grow your event success
            ...
            {[
              {
                icon: UserPlus,
                title: 'Sign Up Free',
                desc: 'Signing up costs nothing. Join the go-to platform for UK Nepalese promoters and start sharing today.',
              },
              {
                icon: Ticket,
                title: 'Hosting Events',
                desc: 'Host one event or a hundred. Our infrastructure handles everything from small workshops to large-scale concerts.',
              },
              {
                icon: BarChart3,
                title: 'Pro Analytics',
                desc: 'Real-time data on ticket sales, attendee demographics, and revenue. Make smarter decisions with deep-dive insights.',
              },
              {
                icon: Heart,
                title: 'Community First',
                desc: "Bridge the gap between your event and the community. We are the direct link to the UK's vibrant Nepalese audience.",
              },
            ].map(
              (feature, i) =>
                feature && (
                  <div
                    key={i}
                    className="bg-card p-10 rounded-[2.5rem] border border-border space-y-6 hover:shadow-xl transition-all group"
                  >
        ...
        <div className="container grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-8">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Are you Nepalese UK event organiser looking to reach thousands of attendees? Let’s
              discuss custom solutions and priority placements for your upcoming events.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link href="/contact-us">
                <Button
                  size="lg"
                  variant="secondary"
                  className="rounded-2xl h-16 px-8 text-lg font-bold flex items-center gap-2"
                >
          ...
          <div className="relative">
            ...
            <div className="bg-card border border-border p-8 rounded-[3.5rem] shadow-2xl space-y-8">
              ...
              {form && <FormBlock enableIntro={false} form={form as any} />}
        ...
        <div className="container text-center space-y-12 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-6">
            <Button
              size="lg"
              variant="secondary"
              className="bg-white text-primary hover:bg-white/90 rounded-2xl h-16 px-10 flex items-center gap-4 transition-all hover:scale-105"
            >
              <svg
          ...
          <div className="pt-12">
            ...
            <Link href="/contact-us">
              <Button
                size="lg"
                variant="secondary"
                className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-primary px-12 py-8 text-xl rounded-full font-bold transition-all"
              >
                SIGN UP YOUR EVENT
              </Button>
            </Link>
