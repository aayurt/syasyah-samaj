...
const FALLBACK_MEMBER_ID = 'SY-NEW'
    ...
    <div className="container mx-auto py-20 px-4">
      <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-16">
        ...
        <div className="relative w-full md:w-80">
            ...
            <Input
                ...
                className="w-full pl-10 pr-4 py-5 rounded-full bg-muted/50 focus:bg-background transition-all h-11"
            />
        </div>
      </div>
      ...
      {members.docs.length > 0 ? (
        ...
        <div className="py-20 text-center border-2 border-dashed border-border rounded-3xl">
          <p className="text-xl text-muted-foreground">No members found yet.</p>
        </div>
      )}
    </div>
  )
